...
$params = array(
	...
	array(
		...
		'description' => esc_html__( 'Select filter by featured tour or none.', 'slzexploore-core' ),
	...
	array(
		...
		'params'     => array(
			array(
				...
				'value'       => $location,
				'description' => esc_html__( 'Choose special location to filter property', 'slzexploore-core'  )
			),
		),
		'value'       => '',
		'description' => esc_html__( 'Default no filter by locaton.', 'slzexploore-core' ),
		'group'       => esc_html__( 'Filter By', 'slzexploore-core')
	),
	array(
		'type'       => 'param_group',
	...
	array(
		...
		'param_name'  => 'btn_book',
		'value'       => '',
		'description' => esc_html__( 'Enter text to read more button', 'slzexploore-core' ),
...
vc_map(array(
	'name'        => esc_html__( 'SLZ Tours Carousel', 'slzexploore-core' ),
	'base'        => 'slzexploore_core_tour_carousel_sc',
	'class'       => 'slzexploore_core-sc',
	'icon'        => 'icon-slzexploore_core_tour_carousel_sc',
	'category'    => SLZEXPLOORE_CORE_SC_CATEGORY,
	'description' => esc_html__( 'List tours in carousel', 'slzexploore-core' ),
	'params'      => $params
));