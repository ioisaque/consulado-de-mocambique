<?php
$category = Slzexploore_Core_Com::get_tax_options2slug( 'slzexploore_cruise_cat', array('empty' => esc_html__( '--All Categories--', 'slzexploore-core' ) ) );
$location = Slzexploore_Core_Com::get_tax_options2slug( 'slzexploore_cruise_location', array('empty' => esc_html__( '--All Locations--', 'slzexploore-core' ) ) );
$author = Slzexploore_Core_Com::get_user_login2id(array(), array('empty' => esc_html__( '-All Authors-', 'slzexploore-core' ) ) );

$sort_by = Slzexploore_Core::get_params('sort-cruise');
...
$params = array(
	array(
		...
		'value'       => $columns,
		'std'         => '2',
		'description' => esc_html__( 'Select column to display list cruises.', 'slzexploore-core' ),
	),
	array(
		'type'        => 'textfield',
	...
	array(
		...
		'param_name'  => 'sort_by',
		'value'       => $sort_by,
		'description' => esc_html__( 'Select order to display list cruises.', 'slzexploore-core' ),
	),
	array(
		'type'        => 'dropdown',
	...
	array(
		'type'        => 'dropdown',
		'heading'     => esc_html__( 'Featured Cruise', 'slzexploore-core' ),
		'param_name'  => 'featured_filter',
		'value'       => $featured_filter,
		'description' => esc_html__( 'Filter by featured cruise or none.', 'slzexploore-core' ),
	...
	array(
		...
		'params'     => array(
			array(
				...
				'value'       => $location,
				'description' => esc_html__( 'Choose special location to filter cruise', 'slzexploore-core'  )
			),
		),
		'value'       => '',
...
vc_map(array(
	'name'        => esc_html__( 'SLZ Cruise Grid', 'slzexploore-core' ),
	'base'        => 'slzexploore_core_cruise_grid_sc',
	'class'       => 'slzexploore_core-sc',
	'icon'        => 'icon-slzexploore_core_cruise_grid_sc',
	'category'    => SLZEXPLOORE_CORE_SC_CATEGORY,
	'description' => esc_html__( 'List cruise in grid.', 'slzexploore-core' ),
	'params'      => $params
));